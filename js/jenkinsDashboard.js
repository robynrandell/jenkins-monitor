	...
	refresh = function () {
		...
		$.ajax({
			...
			error: function (XHR, textStatus, errorThrown) {
				$("#content").html('<h1 id="error_loading">Error retrieving build status</h1>');
			}
		});
		soundQueue.play();
	},
	
	auto_refresh = setInterval(refresh, config.refreshInterval || 30000),
	
	avoidBurnin = setInterval(function () {
